...
//   const handleSettingChange = (key: string, isEnabled: boolean) => {
//     setSettings((prev) => ({ ...prev, [key]: isEnabled }))

//     const label = key.replace(/([A-Z])/g, " $1").replace(/^./, (str) => str.charAt(0).toUpperCase() + str.slice(1))

//     toast({
//       title: "Setting Updated",
//       description: `${label} has been ${isEnabled ? "enabled" : "disabled"}.`,
//     })
//   }
...
//                     onCheckedChange={(isEnabled) => handleSettingChange("emailNotifications", isEnabled)}
//                   />
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center space-x-2">
...
//                     onCheckedChange={(isEnabled) => handleSettingChange("smsNotifications", isEnabled)}
//                   />
//                 </div>
//               </div>
//             </div>
...
//                     onCheckedChange={(isEnabled) => handleSettingChange("maintenanceMode", isEnabled)}
//                   />
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center space-x-2">
...
//                     onCheckedChange={(isEnabled) => handleSettingChange("userRegistration", isEnabled)}
//                   />
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center space-x-2">
...
//                     onCheckedChange={(isEnabled) => handleSettingChange("jobPosting", isEnabled)}
//                   />
//                 </div>
//                 <div className="flex items-center justify-between">
//                   <div className="flex items-center space-x-2">
...
//                     onCheckedChange={(isEnabled) => handleSettingChange("autoApproval", isEnabled)}
//                   />
//                 </div>
//               </div>
//             </div>
